...
$config['backends'][] = array(
    ...
    // 'baseUrl' => 'http://' . $_SERVER['HTTP_HOST'] . 'landing/uploads/',
    'baseUrl' => '/',
...
$config['resourceTypes'][] = array(
    ...
    'maxSize' => '100M',
    'allowedExtensions' => '7z,avi,bmp,csv,doc,docx,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions' => '',
    'backend' => 'default'
);
