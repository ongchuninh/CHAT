...
namespace Gamota\CmsInstall\Console\Commands;
...
class CmsInstall extends Command
{
     ...
     * @var string
     */
    protected $description = 'GamotaCMS install wizard';
    ...
    {
        if (env('installed')) {
            $this->line('GamotaCMS has already been installed.');
        } else {
            $this->comment(PHP_EOL.'Welcome to the GamotaCMS Install Wizard! You\'ll be up and running in no time...');
            ...
            try {
                ...
                $this->line(PHP_EOL.'GamotaCMS has been installed. Pretty easy?'.PHP_EOL);

                // Display installation info...
                $user = \Gamota\Dashboard\User::first();
                ...
                $this->line(PHP_EOL.'If this error persists please consult https://.'.PHP_EOL);
            }
        }
    }
}
