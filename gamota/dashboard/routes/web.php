...
Route::group(['namespace' => 'Gamota\Dashboard\Http\Controllers\Admin', 'middleware' => ['web'], 'prefix' => 'admin'], function () {
    Route::get('/', function () {
    ...
    Route::post('user/appplyStatus/{status?}', 'UserController@appplyStatus')->name('admin.user.appplyStatus')->middleware('can:admin.user.enable,user');
    ...
    Route::get('gallery/create', 'GalleryController@create')->name('admin.gallery.create')->middleware('can:admin');
    Route::get('gallery/category/', 'CategoryController@index')->name('admin.gallery.category.index');
    Route::get('gallery/category/create', 'CategoryController@create')->name('admin.gallery.category.create');
});

/*
Route::group(['namespace' => 'Phambinh\Cms\Http\Controllers\Gamota', 'middleware' => ['web'], 'prefix' => 'admin/slider'], function () {
    //Slider
    Route::get('/', 'SliderController@show_all')->name('admin.slider.show_all');
    ...
    Route::put('{slider}', 'SliderController@update')->name('admin.slider.update');
    Route::put('{slider}/disable', 'SliderController@disable')->name('admin.slider.disable');
    Route::put('{slider}/enable', 'SliderController@enable')->name('admin.slider.enable');
    Route::delete('{slider}', 'SliderController@destroy')->name('admin.slider.destroy');
});
*/

Route::group(['namespace' => 'Gamota\Dashboard\Http\Controllers\Api', 'middleware' => ['web'], 'prefix' => 'api/v1'], function () {
