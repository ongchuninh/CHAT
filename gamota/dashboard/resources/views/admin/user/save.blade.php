	...
	{!! Form::ajax(['method' => isset($user_id) ? 'PUT' : 'POST', 'url' => isset($user_id) ? route('admin.user.update', ['id' => $user_id]) : route('admin.user.store'), 'class' => 'form-horizontal']) !!}
		<div class="form-body">
			...
			<div class="form-group last">
				...
				<div class="col-sm-7">
					{!! Form::select('user[role_id]', Gamota\Dashboard\Role::get()->mapWithKeys(function ($item) {
			...
			<div class="form-group last">
				...
				<div class="col-sm-7">
					{!! Form::select('user[status]', \Gamota\Dashboard\User::statusable()->mapWithKeys(function ($item) {
