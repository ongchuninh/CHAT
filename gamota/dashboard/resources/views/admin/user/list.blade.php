	...
	@component('Cms::components.table-function', [
			...
			<div class="row">
				<div class="col-sm-6 md-pr-0">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::select('role_id', Gamota\Dashboard\Role::get()->mapWithKeys(function ($item) {
				...
				<div class="col-sm-6 md-pl-0">
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::select('status', \Gamota\Dashboard\User::statusable()->mapWithKeys(function ($item) {
		...
		@slot('heading')
			...
			<th class="text-center hidden-xs">
				{!! \Gamota\Dashboard\User::linkSort('ID', 'id') !!}
			</th>
			<th>
				{!! \Gamota\Dashboard\User::linkSort(trans('user.firstname'), 'first_name') !!}
			</th>
			<th class="hidden-xs">
				{!! \Gamota\Dashboard\User::linkSort(trans('user.date_update'), 'updated_at') !!}
			</th>
			<th></th>
		@endslot
