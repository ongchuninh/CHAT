	...
	@component('Cms::components.table-function', [
		...
		@slot('heading')
			...
			<th class="text-center hidden-xs">
				{!! \Gamota\Dashboard\Role::linkSort(trans('role.id'), 'id') !!}
			</th>
			<th>
				{!! \Gamota\Dashboard\Role::linkSort(trans('role.name'), 'name') !!}
			</th>
			<th class="text-center hidden-xs">
				{!! \Gamota\Dashboard\Role::linkSort(trans('role.total-user'), 'total_user') !!}
			</th>
			<th class="hidden-xs">
				{!! \Gamota\Dashboard\Role::linkSort(trans('role.date-update'), 'updated_at') !!}
			</th>
			<th></th>
		@endslot
