...
@section('blank.main')
    <div class="page-header navbar navbar-fixed-top">
        <div class="page-header-inner ">
            <div class="page-logo">
                <a href="{{ url('/') }}">
                    <img src="{{ setting('logo', url('gamota_logo.png')) }}" alt="logo" class="logo-default" /> </a>
    ...
    <div class="container">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2019 - {{ date('Y') }} &copy; GamotaCms
                <a href="https://gamota.com" target="_blank">Gamota.com</a>
            </div>
