...
class Module
{
    ...
    public function registerFromComposerJson($moduleBasePath)
    {
        ...
        if (\File::exists($composerFilePath)) {
            ...
            if (isset($moduleInfo['extra']['gamotacms-module'])) {
                $moduleInfo = array_merge($moduleInfo, $moduleInfo['extra']['gamotacms-module']);

                if (isset($moduleInfo['extra']['gamotacms-module']['type'])) {
                    $moduleInfo['type'] = $moduleInfo['extra']['gamotacms-module']['type'];
                } else {
