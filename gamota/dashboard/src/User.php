...
use Gamota\Dashboard\Support\Traits\FullName;
use Gamota\Dashboard\Support\Traits\Avatar;
...
class User extends AppUser
{
    ...
    {
        return $this->hasMany('Gamota\Dashboard\Mail', 'receiver_id');
    }

    public function outbox()
    {
        return $this->hasMany('Gamota\Dashboard\Mail', 'sender_id');
    }
