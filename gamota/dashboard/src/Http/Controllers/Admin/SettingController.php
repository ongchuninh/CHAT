...
namespace Gamota\Dashboard\Http\Controllers\Admin;
...
class SettingController extends AdminController
{
    ...
    public function general()
    {
        ...
        $this->data['google_analytics_script'] = setting('google-analytics-script');
        $this->data['facebook_ads_script'] = setting('facebook-ads-script');
        $this->data['facebook_fanpage'] = setting('facebook-fanpage');
        $this->data['facebook_group'] = setting('facebook-group');
        ...
        $this->data['logo'] = setting('logo', url('gamota_logo.png'));
    ...
    public function generalUpdate(Request $request)
    {
        ...
        setting()->sync('google-analytics-script', $request->input('google_analytics_script'));
        setting()->sync('facebook-ads-script', $request->input('facebook_ads_script'));
        setting()->sync('facebook-fanpage', $request->input('facebook_fanpage'));
        setting()->sync('facebook-group', $request->input('facebook_group'));
