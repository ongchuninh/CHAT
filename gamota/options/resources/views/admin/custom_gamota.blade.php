@extends('Cms::layouts.default',[
    'active_admin_menu'     => ['option', 'option.listNew'],
    'breadcrumbs'           => [
        'title' => [trans('Options::option.option'), 'Thiết lập trang Gamota', trans('cms.edit')],
        'url'   => [
...
@section('page_title', 'Thiết lập trang Gamota')
@push('css')
    <link rel="stylesheet" type="text/css" href="/assets/admin/global/css/n-custom.css" />
@endpush
@section('content')
    
    {!! Form::ajax(['url' => route('admin.option.updateGamota'), 'class' => 'form-horizontal form-bordered form-row-stripped', 'method' => isset($links_id) ? 'PUT' : 'POST']) !!}
        <div>
            <h4>Thiết lập SEO</h4>
            <hr>
            ...
            <hr>
            <h4>Thiết lập Task Quá trình phát triển</h4>
                            ...
                            <div class="tabBlock-pane">
                                ...
                                <div class="form-group media-box-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        class="form-control" cols="30" rows="10" >{{ $data->text_content->content->{$value->code} }}</textarea>
                                    </div>
                                </div>
                            </div>
                            @endforeach
            ...
            <div class="form-group" style="margin-top: 20px;">
                <label class="control-label col-md-2"> Timeline <button type="button"  class="btn btn-success add-timeline""><i class="fa fa-plus"></i></button></label>
                
                <div class="col-md-8 list-timeline">
                    @if(!empty($data->timeline->image))       
                  
                    @foreach($data->timeline->image as $k => $value)
                        <div class="list-timeline-detail">
                            <div class="row " style="margin-bottom: 20px; padding-top: 7px;">
                                <div class="col-md-2">
                                    
                                    <button type="button" class="btn btn-danger remove-timeline"><i class="fa fa-times"></i></button>
                                    <button type="button" class="btn btn-success add-timeline"><i class="fa fa-plus"></i></button>
                                
                                </div>
                                <div class="col-md-7">
                                    <div class="input-box" style="position: relative;width: 100%;">
                                        <input id="thumbnail" type="text" name="timeline[image][]" class="form-control"
                                                value="{{ $value }}"
                                                readonly="" placeholder="Đường dẫn ảnh"
                                                style="position: relative;width: 100%;">
                            ...
                            <div class="form-group media-box-group">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="timeline[year][]" value="{{ $data->timeline->year[$k] }}">
                                </div>
                            </div>
                            <div class="form-group media-box-group">
                                <label class="control-label col-md-2">
                                        ...
                                        <div class="tabBlock-content">
                                            ...
                                            <div class="tabBlock-pane">
                                                ...
                                                <div class="form-group media-box-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea name="timeline[content][{{ $value->code }}][]" 
                                                        class="form-control" cols="30" rows="10">{{ $data->timeline->content->{$value->code}[$k] }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            @endforeach
...
@push('js_footer')
    ...
    <script>
        $('document').ready(function(){
           ...
           //CKEDITOR.replaceAll('ckeditorn');
        //   CKEDITOR.replace('editor');
        //   CKEDITOR.replace('ckeditor0cn');
            ...
            $('body').on('click', '.add-timeline', function(){
                let html = `<div class="list-timeline-detail">
                                <div class="row " style="margin-bottom: 20px; padding-top: 7px;">
                                    <div class="col-md-2">
                                ...
                                <div class="form-group media-box-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control" name="timeline[year][]" value="">
                                    </div>
                                </div>
                                <div class="form-group media-box-group">
                                    <label class="control-label col-md-2">
                                            ...
                                            <div class="tabBlock-content">
                                                ...
                                                <div class="tabBlock-pane">
                                                    ...
                                                    <div class="form-group media-box-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea name="timeline[content][{{ $value->code }}][]" class="form-control" cols="30" rows="10"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                @endforeach
            ...
            $('body').on('click', '.remove-timeline', function(){
                
                $(this).closest('.list-timeline-detail').remove();
