...
@section('content')
	@component('Cms::components.table-function', [
		'total' => $pages->total(),
		'paginate' => $pages->appends($filter)->render(),
		'bulkactions' => [
			['action' => 'admin/page/appplyStatusPage/enable', 'name' => trans('cms.enable'), 'method' => 'POST' ],
			['action' => 'admin/page/appplyStatusPage/disable', 'name' => trans('cms.disable'), 'method' => 'POST'],
			['action' => 'admin/page/appplyStatusPage/destroy', 'name' => trans('cms.destroy'), 'method' => 'DELETE'],
		],
	])
		@slot('filter')
			<div class="row">
                <div class="col-sm-6 md-pr-0">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                        	{!! Form::select('status', \Gamota\Page\Page::statusable()->mapWithKeys(function ($item) {
		...
		@slot('heading')
			...
			<th width="50" class="text-center">
				{!! \Gamota\Page\Page::linkSort(trans('page.id'), 'id') !!}
			</th>
			<th>
				{!! \Gamota\Page\Page::linkSort(trans('page.title'), 'title') !!}
			</th>
			<th>
				@lang('page.author')
			</th>
			<th>
				{!! \Gamota\Page\Page::linkSort(trans('page.date_update'), 'updated_at') !!}
			</th>
