...
Route::group(['package' => 'page', 'middleware' => ['web'], 'namespace' => 'Admin', 'prefix' => 'admin/page'], function () {
    ...
    Route::post('/appplyStatusPage/{status?}', 'PageController@appplyStatusPage')->name('admin.page.appplyStatusPage')->middleware('can:admin.page.enable,page');
    Route::delete('/appplyStatusPage/{status?}', 'PageController@appplyStatusPage')->name('admin.page.appplyStatusPage')->middleware('can:admin.page.destroy,page');
