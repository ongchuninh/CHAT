 ...
 * @package: PackagesCMS
 */
namespace Gamota\Event\Providers;
...
class ModuleServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // Load helper
        // include __DIR__ . '/../../helper/acc_helper.php';
        // include __DIR__ . '/../../helper/role_helper.php';
    ...
    {
        \AccessControl::define(trans('membership.member') .' - '. trans('membership.list-members'), 'admin.event.membership.index');
        \AccessControl::define(trans('membership.member') .' - '. trans('membership.list-role'), 'admin.event.membership.list_role');
        /*
