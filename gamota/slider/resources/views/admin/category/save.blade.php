    ...
    {!! Form::ajax(['url' => isset($slider_id) ? route('admin.slider.update', ['id' => $slider->id])  : route('admin.slider.store'), 'class' => 'form-horizontal form-bordered form-row-stripped', 'method' => isset($slider_id) ? 'PUT' : 'POST']) !!}
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <input value="{{ $slider->url }}" name="slider[url]" type="text" placeholder="" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    {!! Form::select('slider[target]', ['_blank' => '_blank' , '_self' => '_self'], $slider->target, ['class' => 'form-control width-auto', 'placeholder' => '']) !!}
                </div>
            </div>
