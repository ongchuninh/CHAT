...
@section('content')
	@component('Cms::components.table-function', [
		...
		'bulkactions' => [
			['action' => 'admin/news/category/appplyStatusCategory', 'name' => trans('cms.destroy'), 'method' => 'DELETE'],
		],
	])
		@slot('heading')
			...
			<th class="text-center">
				{!! \Gamota\News\Category::linkSort(trans('news.category.id'), 'id') !!}
			</th>
			<th>Thumbnail</th>
			<th>
				{!! \Gamota\News\Category::linkSort(trans('news.category.title'), 'title') !!}
			</th>
			<th>
				{!! \Gamota\News\Category::linkSort(trans('news.category.date_update'), 'updated_at') !!}
			</th>
			<th></th>
