...
Route::group(['module' => 'news', 'namespace' => 'Gamota\News\Http\Controllers\Admin', 'middleware' => ['web'], 'prefix' => 'admin/news'], function () {
    ...
    Route::post('/appplyStatusNews/{status?}', 'NewsController@appplyStatusNews')->name('admin.news.appplyStatusNews')->middleware('can:admin.news.enable,news');
    Route::delete('/appplyStatusNews/{status?}', 'NewsController@appplyStatusNews')->name('admin.news.appplyStatusNews')->middleware('can:admin.news.destroy,news');
    ...
    Route::delete('category/appplyStatusCategory', 'CategoryController@appplyStatusCategory')->name('admin.news.category.destroy')->middleware('can:admin.news.category.destroy,category');
});

//FrontEnd
Route::group(['module' => 'news', 'namespace' => 'Gamota\News\Http\Controllers\Frontend'], function () {
    Route::get('/{any}.html', 'NewsController@listdetail')->name('frontend.news.index');
});
